...
var Dajaxice = {
    ...
    save_user_coordinates: function(callback_function, argv, custom_settings){
        return Dajaxice.call('core.save_user_coordinates', 'POST', callback_function, argv, custom_settings);
    },

    get_near_topics: function(callback_function, argv, custom_settings){
        return Dajaxice.call('core.get_near_topics', 'POST', callback_function, argv, custom_settings);
    }
